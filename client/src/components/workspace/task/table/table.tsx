  ...
  return (
    <div className="w-full space-y-2">
      ...
      <div className="block w-full lg:flex lg:items-center lg:justify-between">
        {
          filtersToolbar && <div className="flex-1">
            {filtersToolbar}
          </div>
        }

        <div className="grid grid-cols-2 gap-2 mb-2 lg:flex lg:items-center lg:gap-2  lg:mr-2 lg:mb-0">
          ...
          <NavLink
            ...
            {
              projectId
                ? `/workspace/${workspaceId}/project/${projectId}/kanban`
                : `/workspace/${workspaceId}/tasks/kanban`
            } className={({ isActive }) =>
              isActive ? "pointer-events-none" : ""
            } >
            {({ isActive }) => (
              <Button
                ...
                className="w-full lg:w-auto"
              >
                <LayoutGrid strokeWidth={2.5} /> Kanban
              </Button>
            )}
          </NavLink>
        </div>
