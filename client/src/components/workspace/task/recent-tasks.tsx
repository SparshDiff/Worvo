...
const RecentTasks = () => {
  ...
  const tasks: TasksType[] = [
    {
      id: "Task-001",
      title: "Update marketing campaign assets gbeirhgf erighbyfweriyhugfbhergbkjwshgbweyhgbewgbweriutghrtgrbkjhbdrkjhgbdrshg",
  ...
  return (
    <div className="flex flex-col space-y-6  ">
      <ul role="list" className="divide-y  divide-gray-300 dark:divide-gray-500">
        {tasks.map((task) => {
          ...
          return (
            <li
              key={task.id}
              className="p-4 flex items-center justify-between hover:bg-gray-200 hover:px-2 hover:rounded-sm transition-colors dark:hover:bg-zinc-900"
            >
              {/* Task Info */}
              ...
              {/* Task Priority */}
              <div className="hidden sm:flex text-sm ml-2">
                <Badge
              ...
              {/* Assignee */}
              <div className="items-center space-x-2 ml-2">
