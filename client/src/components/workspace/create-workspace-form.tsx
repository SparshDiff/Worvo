  ...
  return (
    <main className="w-full flex flex-row min-h-[590px] h-auto max-w-full">
      <div className="h-full px-10 py-10 flex-1">
        <div className="mb-5">
          <h1
            className="text-2xl dark:text-[#fcfdffef] font-semibold mb-1.5
      ...
      <div className="relative flex-1 shrink-0 hidden md:block bg-[url('/images/workspace.jpg')] bg-cover bg-center h-full"/>
    </main>
  );
}
